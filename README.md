...
### Usage
Clips must be added to Assets as .mp4 files, with the naming scheme "*game*\_*clipnumber*\_*cliporder*". (a_b_1 is the clip up until the first hit, a_b_2 is the entire clip)  
